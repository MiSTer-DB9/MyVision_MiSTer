...
UPSTREAM_REPO="https://github.com/MiSTer-devel/MyVision_MiSTer.git"
CORE_NAME=(MyVision)
...
UPSTREAM_CORE_NAME=(MyVision)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(MyVision.qpf)
COMPILATION_OUTPUT=(output_files/MyVision.rbf)
